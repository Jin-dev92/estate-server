...
>
> **운영·견고함 후속(M8·M9·CI)** — M0~M7로 핵심 기능·정합성·부하 baseline은 끝났고, 그 위에 운영 견고함을 얹는 후속이다. 각 항목의 배경·트레이드오프는 [학습 노트](docs/study/마일스톤-학습-노트.md)(부하 stress/spike §8.5, Outbox DLQ §8)에 정리해 두었다. 순서는 느슨하며 우선순위에 따라 조정한다.
